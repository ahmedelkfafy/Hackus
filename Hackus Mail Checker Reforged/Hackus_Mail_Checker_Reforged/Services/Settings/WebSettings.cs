	...
	internal class WebSettings : BindableObject
	{
		...
		public bool RebruteCaptcha
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(RebruteCaptcha));
			}
		}
		...
		public int RebruteCaptchaLimit
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(RebruteCaptchaLimit));
			}
		}
		...
		public bool CheckWeb
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckWeb));
			}
		}
		...
		public bool CheckMailRu
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckMailRu));
			}
		}
		...
		public MailRuMethod MailRuMethod
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(MailRuMethod));
			}
		}
		...
		public bool CheckYandex
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckYandex));
			}
		}
		...
		public bool CheckRambler
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckRambler));
			}
		}
		...
		public bool CheckGmx
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckGmx));
			}
		}
		...
		public bool CheckOnet
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckOnet));
			}
		}
		...
		public bool CheckProton
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckProton));
			}
		}
		...
		public bool CheckYahoo
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckYahoo));
			}
		}
		...
		public bool CheckAol
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckAol));
			}
		}
		...
		public bool CheckApple
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckApple));
			}
		}
		...
		public bool CheckInteria
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckInteria));
			}
		}
		...
		public bool CheckSeznam
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CheckSeznam));
			}
		}
		...
		public bool SolveCaptcha
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(SolveCaptcha));
			}
		}
		...
		public CaptchaSolvationService CaptchaSolvationService
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CaptchaSolvationService));
			}
		}
		...
		public string CaptchaSolvationKey
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(CaptchaSolvationKey));
			}
		}
		...
		public bool ParseMailRuContacts
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(ParseMailRuContacts));
			}
		}
		...
		public bool DeleteMailRuWarningMessages
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(DeleteMailRuWarningMessages));
			}
		}
		...
		public bool DeleteYandexWarningMessages
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(DeleteYandexWarningMessages));
			}
		}
		...
		public bool EnableYandexImapAccess
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(EnableYandexImapAccess));
			}
		}
		...
		public bool EnableGmxImapAccess
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(EnableGmxImapAccess));
			}
		}
		...
		public bool DeleteYahooWarningMessages
		{
			...
			set
			{
				...
				base.OnPropertyChanged(nameof(DeleteYahooWarningMessages));
			}
		}
